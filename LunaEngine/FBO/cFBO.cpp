...
//***************************************************************
	...
	float edgeColour[] = { 1.0f, 1.0f, 1.0f, 1.0f };
	glTexParameterfv(GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, edgeColour);
...
//						 this->depthTexture_ID, 0);
	...
	glDrawBuffers(6, draw_bufers);		// There are 6 outputs now
