...
void cAnimationMesh::CalculateExtents(void)
{
...
void cAnimationMesh::CalculateNormals(void)
{
...
glm::vec3 cAnimationMesh::CalculateClosestPointOnMesh( glm::vec3 pointToTest )
{
...
glm::vec3 cAnimationMesh::ClosestPtPointTriangle(glm::vec3 p, glm::vec3 a, glm::vec3 b, glm::vec3 c)
{
